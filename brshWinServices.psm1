...
[string] $script:AppName = 'brshWinServices'
# Current script path
...
#region Load Formats
if (test-path $ScriptPath\formats\brshWinServices.format.ps1xml) {
	Update-FormatData $ScriptPath\formats\brshWinServices.format.ps1xml
}
...
$ExecutionContext.SessionState.Module.OnRemove = {
	...
	Get-ChildItem alias: | Where-Object { $_.Source -match "brshWinServices" } | Remove-Item
	Get-ChildItem function: | Where-Object { $_.Source -match "brshWinServices" } | Remove-Item
	Get-ChildItem variable: | Where-Object { $_.Source -match "brshWinServices" } | Remove-Item
}
